...
//        via the IDE. To change SDKROOT through xcconfigs, use user-release-libvox.h rather.
...
// be updated for both debug and release (since this file only affects release). If you need a common definition,
