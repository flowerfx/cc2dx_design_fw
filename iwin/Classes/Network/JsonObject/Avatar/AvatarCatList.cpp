#include "AvatarCatList.h"
#include "json/writer.h"
namespace iwinmesage
{
	
	AvatarCatList:: AvatarCatList ()
	{
	...
	rapidjson::Document AvatarCatList::toJson()
	{
	...
	void AvatarCatList::toData(std::string json)
	{
		rapidjson::Document document;
		document.Parse(json.c_str());
		toData(document);
	}
	void AvatarCatList::toData(rapidjson::Document & document)
	{
