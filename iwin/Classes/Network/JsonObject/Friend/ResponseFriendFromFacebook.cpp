#include "ResponseFriendFromFacebook.h"
#include "json/writer.h"
namespace iwinmesage
{
	
	ResponseFriendFromFacebook:: ResponseFriendFromFacebook ()
	{
	...
	rapidjson::Document ResponseFriendFromFacebook::toJson()
	{
	...
	void ResponseFriendFromFacebook::toData(std::string json)
	{
		rapidjson::Document document;
		document.Parse(json.c_str());
		toData(document);
	}
	void ResponseFriendFromFacebook::toData(rapidjson::Document & document)
	{
